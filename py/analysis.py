...
mun_pivot = pd.pivot_table(mun_table,values='date',index=["mun_result","csk_result"],aggfunc='count')
csk_pivot = pd.pivot_table(csk_table,values='date',index=["csk_result","mun_result"],aggfunc='count')
...
print "Table when utd wins"
print mun_table
print "Table when csk wins"
print csk_table
